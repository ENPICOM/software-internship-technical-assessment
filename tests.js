...
const testCases = [
    ...
    { message: 'a simple valid SIN that remains valid if reversed', input: '950', expected: 0 },
    { message: 'a simple valid SIN that becomes invalid if reversed', input: '59', expected: 0 },
    { message: 'a simple valid SIN that becomes invalid if reversed', input: '95', expected: 42 },
